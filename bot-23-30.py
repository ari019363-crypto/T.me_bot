...
def generate_terrifying_math_question():
    ...
    if kind == "pythagoras":
        ...
        return c, f"تو یه مثلثِ قائم‌الزاویه، دو ضلع {a} و {b}؛ ضلعِ سوم (وتر) چنده؟"
    ...
    if random.random() < 0.5:
        ...
        d = v * t
        return v, f"ماشینی مسافتِ {d} کیلومتر رو تو {t} ساعت رفته؛ سرعتش چند km/h؟ (v=d/t)"
    m = random.randint(2, 20)
    accel = random.randint(2, 15)
    return m * accel, f"جرمِ {m} کیلوگرم با شتابِ {accel} m/s²، چند نیوتون نیرو وارد می‌کنه؟ (F=m×a)"
