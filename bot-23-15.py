...
CHALLENGE_CLEANUP_DELAY_SECONDS = 300  # ۵ دقیقه؛ بعد از جوابِ درست، پیام‌های چالش پاک می‌شن
CHALLENGE_WRONG_ANSWER_CLEANUP_SECONDS = 20  # پیامِ «جواب غلط» بعد از این‌قدر ثانیه پاک می‌شه
    ...
    try:
        ...
        if context.job_queue is not None:
            context.job_queue.run_once(
                ...
                CHALLENGE_WRONG_ANSWER_CLEANUP_SECONDS,
